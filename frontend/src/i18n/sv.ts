...
const sv: Language = {
  ...
  ui: {
    ...
    "recipes.empty": "Inga recept ännu. Skapa ditt första recept!",
    "recipes.new": "+ Nytt recept",
    "recipes.ingredientCount": "{count} ingredienser",
    "recipes.loading": "Laddar recept...",
    "recipes.sortLabel": "Sortera recept",
    "recipes.sortAlphabetical": "A–Ö",
    "recipes.sortRecent": "Senaste",
    "recipes.lastAdded": "På listan {when}",
    "recipes.neverAdded": "Aldrig på listan",
    "recipeForm.newTitle": "Nytt recept",
    "recipeForm.editTitle": "Redigera recept",
    "recipeForm.name": "Namn",
    "recipeForm.namePlaceholder": "t.ex. Tacos",
    "recipeForm.ingredients": "Ingredienser",
    "recipeForm.addIngredient": "Lägg till ingrediens...",
    "recipeForm.noIngredients": "Lägg till minst en ingrediens",
    "recipeForm.emptyName": "Ange ett namn",
    "recipeForm.saveFailed": "Kunde inte spara receptet",
    "recipeForm.save": "Spara",
    "recipeForm.cancel": "Avbryt",
    "recipeForm.saving": "Sparar...",
    "recipeDetail.back": "Tillbaka",
    "recipeDetail.edit": "Redigera",
    "recipeDetail.delete": "Ta bort",
    "recipeDetail.confirmDelete": "Bekräfta?",
    "recipeDetail.deleteFailed": "Kunde inte ta bort receptet",
    "recipeDetail.addToList": "Lägg till på listan",
    "recipeDetail.adding": "Lägger till...",
    "recipeDetail.added": "Tillagt!",
    "recipeDetail.lastBought": "Köpt {when}",
    "recipeDetail.neverBought": "Aldrig köpt",
    "recipeDetail.selectAll": "Markera alla",
    "recipeDetail.deselectAll": "Avmarkera alla",
    "recipeDetail.removedItem": "(borttagen vara)",
